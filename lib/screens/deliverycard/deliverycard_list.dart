...
Widget build(BuildContext context) {
  list.add(new DeliveryCardModel("ahmad muhamad", "07700054655", "ahmadahmadmu00546550000@gmail.com", "12345", DateTime.now(), DateTime.now(), "kalar-bngrd", "belal omar muhamd", "2344 slui-iraq", "20000", "0", "0", "20000"));
